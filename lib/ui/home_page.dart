...
class _HomePageState extends State<HomePage> {
  ...
  int minute = 0;
  int second = 0;
  ValueNotifier<CourseLeftTime> courseLeftTime =
      ValueNotifier(CourseLeftTime(0, 0, 0));
